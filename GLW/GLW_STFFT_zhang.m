function varargout = GLW_STFFT_zhang(varargin)
% GLW_STFFT_zhang MATLAB code for GLW_STFFT_zhang.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_STFFT_zhang_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_STFFT_zhang_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_STFFT_zhang is made visible.
function GLW_STFFT_zhang_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_STFFT_zhang (see VARARGIN)
% Choose default command line output for GLW_STFFT_zhang
...
function varargout = GLW_STFFT_zhang_OutputFcn(hObject, eventdata, handles) 
