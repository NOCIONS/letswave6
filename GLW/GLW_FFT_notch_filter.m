function varargout = GLW_FFT_notch_filter(varargin)
% GLW_FFT_NOTCH_FILTER MATLAB code for GLW_FFT_notch_filter.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_FFT_notch_filter_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_FFT_notch_filter_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_FFT_notch_filter is made visible.
function GLW_FFT_notch_filter_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_FFT_notch_filter (see VARARGIN)
% Choose default command line output for GLW_FFT_notch_filter
...
%!!!!!!!!!!!!!!!!!!!!!!!!
%notch_frequency_edit
set(handles.notch_frequency_edit,'String',num2str(configuration.parameters.notch_frequency));
%notch_width_edit
...
function varargout = GLW_FFT_notch_filter_OutputFcn(hObject, eventdata, handles) 
...
%!!!!!!!!!!!!!!!!!!!!
%noch_frequency
configuration.parameters.notch_frequency=str2num(get(handles.notch_frequency_edit,'String'));
%notch_width
...
function notch_frequency_edit_Callback(hObject, eventdata, handles)
% hObject    handle to notch_frequency_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function notch_frequency_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to notch_frequency_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
...
function notch_width_edit_Callback(hObject, eventdata, handles)
% hObject    handle to notch_width_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function notch_width_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to notch_width_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
...
function notch_slope_width_edit_Callback(hObject, eventdata, handles)
% hObject    handle to notch_slope_width_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function notch_slope_width_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to notch_slope_width_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
