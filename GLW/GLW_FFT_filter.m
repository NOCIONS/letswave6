function varargout = GLW_FFT_filter(varargin)
% GLW_FFT_FILTER MATLAB code for GLW_FFT_filter.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_FFT_filter_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_FFT_filter_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_FFT_filter is made visible.
function GLW_FFT_filter_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_FFT_filter (see VARARGIN)
% Choose default command line output for GLW_FFT_filter
...
%low_width_edit
set(handles.low_width_edit,'String',num2str(configuration.parameters.low_width));
%high_cutoff_edit
set(handles.high_cutoff_edit,'String',num2str(configuration.parameters.high_cutoff));
%high_width_edit
set(handles.high_width_edit,'String',num2str(configuration.parameters.high_width));
%update_edit_boxes
...
function varargout = GLW_FFT_filter_OutputFcn(hObject, eventdata, handles) 
...
%low_width
configuration.parameters.low_width=str2num(get(handles.low_width_edit,'String'));
%high_width
configuration.parameters.high_width=str2num(get(handles.high_width_edit,'String'));
%!!!
%END
%!!!
...
switch filter_type
    case 'bandpass'
        ...
        set(handles.low_width_edit,'Visible','on');
        set(handles.low_width_text,'Visible','on');
        set(handles.high_width_edit,'Visible','on');
        set(handles.high_width_text,'Visible','on');
    case 'lowpass'
        set(handles.low_cutoff_edit,'Visible','off');
        set(handles.low_cutoff_text,'Visible','off');
        set(handles.high_cutoff_edit,'Visible','on');
        set(handles.high_cutoff_text,'Visible','on');
        set(handles.low_width_edit,'Visible','off');
        set(handles.low_width_text,'Visible','off');
        set(handles.high_width_edit,'Visible','on');
        set(handles.high_width_text,'Visible','on');
    case 'highpass'
        set(handles.low_cutoff_edit,'Visible','on');
        ...
        set(handles.low_width_edit,'Visible','on');
        set(handles.low_width_text,'Visible','on');
        set(handles.high_width_edit,'Visible','off');
        set(handles.high_width_text,'Visible','off');
    case 'notch'
        set(handles.low_cutoff_edit,'Visible','on');
        set(handles.low_cutoff_text,'Visible','on');
        set(handles.high_cutoff_edit,'Visible','on');
