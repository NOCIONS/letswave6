function varargout = GLW_linear_channel_map(varargin)
% GLW_LINEAR_CHANNEL_MAP MATLAB code for GLW_linear_channel_map.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_linear_channel_map_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_linear_channel_map_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_linear_channel_map is made visible.
function GLW_linear_channel_map_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_linear_channel_map (see VARARGIN)
% Choose default command line output for GLW_linear_channel_map
...
function varargout = GLW_linear_channel_map_OutputFcn(hObject, eventdata, handles) 
