function varargout = GLW_pan_tompkin(varargin)
% GLW_PAN_TOMPKIN MATLAB code for GLW_pan_tompkin.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_pan_tompkin_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_pan_tompkin_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_pan_tompkin is made visible.
function GLW_pan_tompkin_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_pan_tompkin (see VARARGIN)
% Choose default command line output for GLW_pan_tompkin
...
for i=1:length(datasets(1).header.chanlocs);
    channel_labels{i}=datasets(1).header.chanlocs(i).labels;
end;
set(handles.channel_popup,'String',channel_labels);
a=find(strcmpi(configuration.parameters.channel_label,get(handles.channel_popup,'String'))==1);
if isempty(a);
else
...
function varargout = GLW_pan_tompkin_OutputFcn(hObject, eventdata, handles) 
...
configuration.parameters.channel_label=st{get(handles.channel_popup,'Value')};
%!!!
%END
%!!!
