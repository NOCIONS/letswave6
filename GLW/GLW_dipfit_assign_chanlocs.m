function varargout = GLW_dipfit_assign_chanlocs(varargin)
% GLW_DIPFIT_ASSIGN_CHANLOCS MATLAB code for GLW_dipfit_assign_chanlocs.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_dipfit_assign_chanlocs_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_dipfit_assign_chanlocs_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_dipfit_assign_chanlocs is made visible.
function GLW_dipfit_assign_chanlocs_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_dipfit_assign_chanlocs (see VARARGIN)
% Choose default command line output for GLW_dipfit_assign_chanlocs
...
%!!!!!!!!!!!!!!!!!!!!!!!!
set(handles.chanloc_filename_edit,'String',configuration.parameters.chanloc_filename);
%!!!
%END
%!!!
...
function varargout = GLW_dipfit_assign_chanlocs_OutputFcn(hObject, eventdata, handles) 
...
%!!!!!!!!!!!!!!!!!!!!
configuration.parameters.chanloc_filename=get(handles.chanloc_filename_edit,'String');
%!!!
%END
%!!!
...
set(handles.chanloc_filename_edit,'String',fullfile(pathname,filename));
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.chanloc_filename_edit,'String','BEM_standard_1005.elc');
