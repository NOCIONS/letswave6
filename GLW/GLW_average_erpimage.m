function varargout = GLW_average_erpimage(varargin)
% GLW_AVERAGE_ERPIMAGE MATLAB code for GLW_average_erpimage.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_average_erpimage_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_average_erpimage_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_average_erpimage is made visible.
function GLW_average_erpimage_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_average_erpimage (see VARARGIN)
% Choose default command line output for GLW_average_erpimage
...
%!!!!!!!!!!!!!!!!!!!!!!!!
%header > use_range_btn Userdata
set(handles.use_range_btn,'Userdata',datasets(1).header);
%configuration.parameters.num_lines=100;
set(handles.num_lines_edit,'String',num2str(configuration.parameters.num_lines));
%configuration.parameters.x_start=0;
...
set(handles.smooth_chk,'Value',configuration.parameters.smooth);
%configuration.parameters.smooth_width=5;
set(handles.smooth_width_edit,'String',num2str(configuration.parameters.smooth_width));
%!!!
%END
%!!!
...
function varargout = GLW_average_erpimage_OutputFcn(hObject, eventdata, handles) 
...
%!!!!!!!!!!!!!!!!!!!!
%configuration.parameters.num_lines=100;
configuration.parameters.num_lines=str2num(get(handles.num_lines_edit,'String'));
%configuration.parameters.x_start=0;
...
function smooth_width_edit_Callback(hObject, eventdata, handles)
% hObject    handle to smooth_width_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function smooth_width_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to smooth_width_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
...
function num_lines_edit_Callback(hObject, eventdata, handles)
% hObject    handle to num_lines_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function num_lines_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to num_lines_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
...
% --- Executes on button press in use_range_btn.
function use_range_btn_Callback(hObject, eventdata, handles)
% hObject    handle to use_range_btn (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
%header
header=get(handles.use_range_btn,'Userdata');
%xstart,xend
xstart=header.xstart;
xend=((header.datasize(6)-1)*header.xstep)+header.xstart;
set(handles.x_start_edit,'String',num2str(xstart));
set(handles.x_end_edit,'String',num2str(xend));
