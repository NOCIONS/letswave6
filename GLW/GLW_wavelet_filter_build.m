function varargout = GLW_wavelet_filter_build(varargin)
% GLW_WAVELET_FILTER_BUILD MATLAB code for GLW_wavelet_filter_build.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_wavelet_filter_build_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_wavelet_filter_build_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_wavelet_filter_build is made visible.
function GLW_wavelet_filter_build_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_wavelet_filter_build (see VARARGIN)
% Choose default command line output for GLW_wavelet_filter_build
...
%
set(handles.start_frequency_edit,'String',num2str(configuration.parameters.start_frequency));
set(handles.end_frequency_edit,'String',num2str(configuration.parameters.end_frequency));
set(handles.frequency_step_edit,'String',num2str(configuration.parameters.frequency_step));
...
function varargout = GLW_wavelet_filter_build_OutputFcn(hObject, eventdata, handles) 
...
configuration.parameters.selected_channel=st;
configuration.parameters.start_frequency=str2num(get(handles.start_frequency_edit,'String'));
configuration.parameters.end_frequency=str2num(get(handles.end_frequency_edit,'String'));
configuration.parameters.frequency_step=str2num(get(handles.frequency_step_edit,'String'));
...
function end_frequency_edit_Callback(hObject, eventdata, handles)
% hObject    handle to end_frequency_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function end_frequency_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to end_frequency_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
...
function frequency_step_edit_Callback(hObject, eventdata, handles)
% hObject    handle to frequency_step_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function frequency_step_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to frequency_step_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
