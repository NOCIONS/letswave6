function varargout = GLW_figure_waveforms(varargin)
% GLW_FIGURE_WAVEFORMS MATLAB code for GLW_figure_waveforms.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_figure_waveforms_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_figure_waveforms_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_figure_waveforms is made visible.
function GLW_figure_waveforms_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_figure_waveforms (see VARARGIN)
% Choose default command line output for GLW_figure_waveforms
...
function varargout = GLW_figure_waveforms_OutputFcn(hObject, eventdata, handles) 
...
for wavepos=1:length(wavedata);
    ...
    ax=subplot(1,1,1);
    %plot
    plot_type=get(handles.plot_popup,'Value');
    switch plot_type
        case 1
            %plot
        ...
        case 2
            %stem
            stem(tpx,tpy,'Color',wavedata(wavepos).color,'LineWidth',wavedata(wavepos).linewidth,'LineStyle',wavedata(wavepos).linestyle);
        case 3
            %stairs
            stairs(tpx,tpy,'Color',wavedata(wavepos).color,'LineWidth',wavedata(wavepos).linewidth,'LineStyle',wavedata(wavepos).linestyle);
    end;
end;
%background color
