function varargout = GLW_import_LW4MAT(varargin)
% GLW_IMPORT_LW4MAT MATLAB code for GLW_import_LW4MAT.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_import_LW4MAT_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_import_LW4MAT_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_import_LW4MAT is made visible.
function GLW_import_LW4MAT_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_import_LW4MAT (see VARARGIN)
% Choose default command line output for GLW_import_LW4MAT
...
function varargout = GLW_import_LW4MAT_OutputFcn(hObject, eventdata, handles) 
