function varargout = GLW_edit_electrodes_labels(varargin)
% GLW_EDIT_ELECTRODES_LABELS MATLAB code for GLW_edit_electrodes_labels.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_edit_electrodes_labels_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_edit_electrodes_labels_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_edit_electrodes_labels is made visible.
function GLW_edit_electrodes_labels_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_edit_electrodes_labels (see VARARGIN)
% Choose default command line output for GLW_edit_electrodes_labels
...
for i=1:length(header.chanlocs);
    st{i,1}=header.chanlocs(i).labels;
    st{i,2}='';
end;
set(handles.chan_table,'Data',st);
%!!!
%END
%!!!
...
function varargout = GLW_edit_electrodes_labels_OutputFcn(hObject, eventdata, handles) 
...
data=data(find(strcmpi(data(:,2),'')==0),:);
%update configuration
if isempty(data);
else
    configuration.parameters.chan_labels=data;
end;
%!!!
%END
%!!!
...
% --- Executes on button press in chanloc_btn.
function chanloc_btn_Callback(hObject, eventdata, handles)
% hObject    handle to chanloc_btn (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
set(handles.chanloc_filename_edit,'String','Standard-10-20-Cap81.locs');
...
if isequal(filename,0);
    ...
    set(handles.chanloc_filename_edit,'String',[pathname,filename]);
end;
...
% --- Executes on button press in load_txt_btn.
function load_txt_btn_Callback(hObject, eventdata, handles)
% hObject    handle to load_txt_btn (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
filterspec={'*.*'};
[filename pathname]=uigetfile(filterspec);
...
% --- Executes on button press in save_TXT_btn.
function save_TXT_btn_Callback(hObject, eventdata, handles)
% hObject    handle to save_TXT_btn (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
filterspec={'*.*'};
...
% --- Executes on button press in load_LW6_btn.
function load_LW6_btn_Callback(hObject, eventdata, handles)
% hObject    handle to load_LW6_btn (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
filterspec={'*.lw6'};
[filename pathname]=uigetfile(filterspec);
