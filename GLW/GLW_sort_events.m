function varargout = GLW_sort_events(varargin)
% GLW_SORT_EVENTS MATLAB code for GLW_sort_events.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_sort_events_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_sort_events_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_sort_events is made visible.
function GLW_sort_events_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_sort_events (see VARARGIN)
% Choose default command line output for GLW_sort_events
...
function varargout = GLW_sort_events_OutputFcn(hObject, eventdata, handles) 
