function varargout = GLW_suppress_artifact(varargin)
% GLW_SUPPRESS_ARTIFACT MATLAB code for GLW_suppress_artifact.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_suppress_artifact_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_suppress_artifact_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_suppress_artifact is made visible.
function GLW_suppress_artifact_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_suppress_artifact (see VARARGIN)
% Choose default command line output for GLW_suppress_artifact
...
function varargout = GLW_suppress_artifact_OutputFcn(hObject, eventdata, handles) 
