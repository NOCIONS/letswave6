function varargout = GLW_pool_channels2(varargin)
% GLW_POOL_CHANNELS2 MATLAB code for GLW_pool_channels2.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_pool_channels2_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_pool_channels2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_pool_channels2 is made visible.
function GLW_pool_channels2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_pool_channels2 (see VARARGIN)
% Choose default command line output for GLW_pool_channels2
...
function varargout = GLW_pool_channels2_OutputFcn(hObject, eventdata, handles) 
...
configuration.parameters.channel_labels=channel_labels(get(handles.channel_listbox,'Value'));
