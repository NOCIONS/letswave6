function varargout = GLW_rectify_signals(varargin)
% GLW_RECTIFY_SIGNALS MATLAB code for GLW_rectify_signals.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_rectify_signals_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_rectify_signals_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_rectify_signals is made visible.
function GLW_rectify_signals_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_rectify_signals (see VARARGIN)
% Choose default command line output for GLW_rectify_signals
...
a=find(strcmpi(st,configuration.parameters.operation));
if isempty(a);
else
...
function varargout = GLW_rectify_signals_OutputFcn(hObject, eventdata, handles) 
