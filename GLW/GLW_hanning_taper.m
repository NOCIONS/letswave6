function varargout = GLW_hanning_taper(varargin)
% GLW_HANNING_TAPER MATLAB code for GLW_hanning_taper.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_hanning_taper_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_hanning_taper_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_hanning_taper is made visible.
function GLW_hanning_taper_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_hanning_taper (see VARARGIN)
% Choose default command line output for GLW_hanning_taper
...
function varargout = GLW_hanning_taper_OutputFcn(hObject, eventdata, handles) 
