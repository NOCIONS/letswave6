function varargout = GLW_dc_removal(varargin)
% GLW_DC_REMOVAL MATLAB code for GLW_dc_removal.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_dc_removal_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_dc_removal_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_dc_removal is made visible.
function GLW_dc_removal_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_dc_removal (see VARARGIN)
% Choose default command line output for GLW_dc_removal
...
%!!!!!!!!!!!!!!!!!!!!!!!!
set(handles.linear_detrend_chk,'Value',configuration.parameters.linear_detrend);
%!!!
%END
%!!!
...
function varargout = GLW_dc_removal_OutputFcn(hObject, eventdata, handles) 
...
%!!!!!!!!!!!!!!!!!!!!
configuration.parameters.linear_detrend=get(handles.linear_detrend_chk,'Value');
%!!!
%END
%!!!
...
% --- Executes on button press in linear_detrend_chk.
function linear_detrend_chk_Callback(hObject, eventdata, handles)
% hObject    handle to linear_detrend_chk (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
