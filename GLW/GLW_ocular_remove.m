function varargout = GLW_ocular_remove(varargin)
% GLW_OCULAR_REMOVE MATLAB code for GLW_ocular_remove.fig

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GLW_ocular_remove_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_ocular_remove_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_ocular_remove is made visible.
function GLW_ocular_remove_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_ocular_remove (see VARARGIN)
% Choose default command line output for GLW_ocular_remove
handles.output = hObject;
% Update handles structure
guidata(hObject, handles);
% UIWAIT makes GLW_ocular_remove wait for user response (see UIRESUME)
...
%channel_idx
channel_idx=configuration.parameters.EOG;
set(handles.listbox1,'Value',channel_idx);
%!!!
%END
%!!!
...
function varargout = GLW_ocular_remove_OutputFcn(hObject, eventdata, handles) 
...
%!!!!!!!!!!!!!!!!!!!!
EOG=get(handles.listbox1,'Value');
configuration.parameters.EOG=EOG;
%!!!
%END
%!!!
