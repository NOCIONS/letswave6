function varargout = GLW_segmentation2(varargin)
% GLW_SEGMENTATION2 MATLAB code for GLW_segmentation2.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_segmentation2_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_segmentation2_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_segmentation2 is made visible.
function GLW_segmentation2_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_segmentation2 (see VARARGIN)
% Choose default command line output for GLW_segmentation2
...
function varargout = GLW_segmentation2_OutputFcn(hObject, eventdata, handles) 
