function varargout = GLW_import_MEGA(varargin)
% GLW_IMPORT_MEGA MATLAB code for GLW_import_MEGA.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_import_MEGA_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_import_MEGA_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_import_MEGA is made visible.
function GLW_import_MEGA_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_import_MEGA (see VARARGIN)
% Choose default command line output for GLW_import_MEGA
...
set(handles.filenames_listbox,'String',configuration.parameters.input_folder);
set(handles.session_number_edit,'String',num2str(configuration.parameters.session_number));
%!!!
%END
%!!!
...
function varargout = GLW_import_MEGA_OutputFcn(hObject, eventdata, handles) 
...
%!!!!!!!!!!!!!!!!!!!!
%configuration.parameters.filenames={};
configuration.parameters.input_folder=get(handles.filenames_listbox,'Userdata');
configuration.parameters.session_number=str2num(get(handles.session_number_edit,'String'));
%!!!
%END
%!!!
...
set(handles.filenames_listbox,'String',directory_name);
set(handles.filenames_listbox,'Userdata',directory_name);
...
function session_number_edit_Callback(hObject, eventdata, handles)
% hObject    handle to session_number_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function session_number_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to session_number_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
