function varargout = GLW_events_level_trigger(varargin)
% GLW_EVENTS_LEVEL_TRIGGER MATLAB code for GLW_events_level_trigger.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_events_level_trigger_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_events_level_trigger_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_events_level_trigger is made visible.
function GLW_events_level_trigger_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_events_level_trigger (see VARARGIN)
% Choose default command line output for GLW_events_level_trigger
...
%selected_channel
if isempty(configuration.parameters.selected_channel);
else
    a=find(strcmpi(configuration.parameters.selected_channel,st));
    if isempty(a);
    else
        set(handles.channel_popup,'Value',a);
    end;
end;
%threshold
set(handles.threshold_edit,'String',num2str(configuration.parameters.threshold));
%min_isi
set(handles.min_isi_edit,'String',num2str(configuration.parameters.min_isi));
%direction
st={};
st{1}='ascending';
st{2}='descending';
set(handles.direction_popup,'Userdata',st);
a=find(strcmpi(configuration.parameters.direction,st));
set(handles.direction_popup,'Value',a);
%event_code
set(handles.event_code_edit,'String',configuration.parameters.event_code);
%!!!
%END
%!!!
...
function varargout = GLW_events_level_trigger_OutputFcn(hObject, eventdata, handles) 
...
%threshold
configuration.parameters.threshold=str2num(get(handles.threshold_edit,'String'));
%min_isi
configuration.parameters.min_isi=str2num(get(handles.min_isi_edit,'String'));
%direction
st=get(handles.direction_popup,'Userdata');
configuration.parameters.direction=st{get(handles.direction_popup,'Value')};
%event_code
configuration.parameters.event_code=get(handles.event_code_edit,'String');
%!!!
%END
%!!!
...
function event_code_edit_Callback(hObject, eventdata, handles)
% hObject    handle to event_code_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function event_code_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to event_code_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
...
function min_isi_edit_Callback(hObject, eventdata, handles)
% hObject    handle to min_isi_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function min_isi_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to min_isi_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
...
% --- Executes on selection change in direction_popup.
function direction_popup_Callback(hObject, eventdata, handles)
% hObject    handle to direction_popup (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function direction_popup_CreateFcn(hObject, eventdata, handles)
% hObject    handle to direction_popup (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
