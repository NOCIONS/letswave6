function varargout = GLW_events_delete_duplicate(varargin)
% GLW_EVENTS_DELETE_DUPLICATE MATLAB code for GLW_events_delete_duplicate.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_events_delete_duplicate_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_events_delete_duplicate_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_events_delete_duplicate is made visible.
function GLW_events_delete_duplicate_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_events_delete_duplicate (see VARARGIN)
% Choose default command line output for GLW_events_delete_duplicate
...
%!!!!!!!!!!!!!!!!!!!!!!!!
%configuration.parameters.exact_latencies
if configuration.parameters.exact_latencies==1;
    set(handles.exact_chk,'Value',1);
    set(handles.jitter_chk,'Value',0);
else
    set(handles.exact_chk,'Value',0);
    set(handles.jitter_chk,'Value',1);
end;
%configuration.parameters.tolerance
set(handles.tolerance_edit,'String',num2str(configuration.parameters.tolerance));
%!!!
%END
%!!!
...
function varargout = GLW_events_delete_duplicate_OutputFcn(hObject, eventdata, handles) 
...
if get(handles.exact_chk,'Value')==1;
    configuration.parameters.exact_latencies=1;
else
    configuration.parameters.exact_latencies=0;
end;
configuration.parameters.tolerance=str2num(get(handles.tolerance_edit,'String'));
%!!!
%END
%!!!
...
% --- Executes on button press in jitter_chk.
function jitter_chk_Callback(hObject, eventdata, handles)
% hObject    handle to jitter_chk (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
if get(handles.jitter_chk,'Value')==1;
    set(handles.exact_chk,'Value',0);
else
    set(handles.exact_chk,'Value',1);
end;
