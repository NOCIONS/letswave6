function varargout = GLW_edit_electrodes(varargin)
% GLW_EDIT_ELECTRODES MATLAB code for GLW_edit_electrodes.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_edit_electrodes_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_edit_electrodes_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_edit_electrodes is made visible.
function GLW_edit_electrodes_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_edit_electrodes (see VARARGIN)
% Choose default command line output for GLW_edit_electrodes
...
function varargout = GLW_edit_electrodes_OutputFcn(hObject, eventdata, handles) 
