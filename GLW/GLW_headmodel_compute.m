function varargout = GLW_headmodel_compute(varargin)
% GLW_HEADMODEL_COMPUTE MATLAB code for GLW_headmodel_compute.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_headmodel_compute_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_headmodel_compute_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_headmodel_compute is made visible.
function GLW_headmodel_compute_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_headmodel_compute (see VARARGIN)
% Choose default command line output for GLW_headmodel_compute
...
function varargout = GLW_headmodel_compute_OutputFcn(hObject, eventdata, handles) 
