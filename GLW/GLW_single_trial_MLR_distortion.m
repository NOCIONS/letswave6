function varargout = GLW_single_trial_MLR_distortion(varargin)
% GLW_SINGLE_TRIAL_MLR_DISTORTION MATLAB code for GLW_single_trial_MLR_distortion.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_single_trial_MLR_distortion_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_single_trial_MLR_distortion_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_single_trial_MLR_distortion is made visible.
function GLW_single_trial_MLR_distortion_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_single_trial_MLR_distortion (see VARARGIN)
% Choose default command line output for GLW_single_trial_MLR_distortion
...
function varargout = GLW_single_trial_MLR_distortion_OutputFcn(hObject, eventdata, handles) 
