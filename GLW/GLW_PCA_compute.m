function varargout = GLW_PCA_compute(varargin)
% GLW_PCA_COMPUTE MATLAB code for GLW_PCA_compute.fig
%      GLW_PCA_COMPUTE, by itself, creates a new GLW_PCA_COMPUTE or raises the existing
%      singleton*.
%
%      H = GLW_PCA_COMPUTE returns the handle to a new GLW_PCA_COMPUTE or the handle to
%      the existing singleton*.
%
%      GLW_PCA_COMPUTE('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in GLW_PCA_COMPUTE.M with the given input arguments.
%
%      GLW_PCA_COMPUTE('Property','Value',...) creates a new GLW_PCA_COMPUTE or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before GLW_PCA_compute_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to GLW_PCA_compute_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help GLW_PCA_compute

% Last Modified by GUIDE v2.5 21-Oct-2015 10:46:55

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @GLW_PCA_compute_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_PCA_compute_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_PCA_compute is made visible.
function GLW_PCA_compute_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_PCA_compute (see VARARGIN)

% Choose default command line output for GLW_PCA_compute
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes GLW_PCA_compute wait for user response (see UIRESUME)
...
function varargout = GLW_PCA_compute_OutputFcn(hObject, eventdata, handles) 
