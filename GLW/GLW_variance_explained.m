function varargout = GLW_variance_explained(varargin)
% GLW_VARIANCE_EXPLAINED MATLAB code for GLW_variance_explained.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_variance_explained_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_variance_explained_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_variance_explained is made visible.
function GLW_variance_explained_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_variance_explained (see VARARGIN)
% Choose default command line output for GLW_variance_explained
...
function varargout = GLW_variance_explained_OutputFcn(hObject, eventdata, handles) 
...
dataset_reference_name=st{get(handles.dataset_popup,'Value')};
configuration.parameters.reference_dataset_name=dataset_reference_name;
%!!!
%END
%!!!
