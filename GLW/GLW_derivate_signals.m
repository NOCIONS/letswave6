function varargout = GLW_derivate_signals(varargin)
% GLW_DERIVATE_SIGNALS MATLAB code for GLW_derivate_signals.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_derivate_signals_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_derivate_signals_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_derivate_signals is made visible.
function GLW_derivate_signals_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_derivate_signals (see VARARGIN)
% Choose default command line output for GLW_derivate_signals
...
function varargout = GLW_derivate_signals_OutputFcn(hObject, eventdata, handles) 
