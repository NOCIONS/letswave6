function varargout = GLW_sort_epochdata(varargin)
% GLW_SORT_EPOCHDATA MATLAB code for GLW_sort_epochdata.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_sort_epochdata_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_sort_epochdata_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_sort_epochdata is made visible.
function GLW_sort_epochdata_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_sort_epochdata (see VARARGIN)
% Choose default command line output for GLW_sort_epochdata
...
%discard_empty
set(handles.discard_empty_chk,'Value',configuration.parameters.discard_empty);
%sort
st=get(handles.sort_popup,'String');
a=find(strcmpi(st,configuration.parameters.sort));
if isempty(a);
else
    set(handles.sort_popup,'Value',a(1));
end;
%!!!
%END
%!!!
...
function varargout = GLW_sort_epochdata_OutputFcn(hObject, eventdata, handles) 
...
%sort
st=get(handles.sort_popup,'String');
configuration.parameters.sort=st{get(handles.sort_popup,'Value')};
%discard_empty
configuration.parameters.discard_empty=get(handles.discard_empty_chk,'Value');
%!!!
%END
%!!!
...
% --- Executes on selection change in sort_popup.
function sort_popup_Callback(hObject, eventdata, handles)
% hObject    handle to sort_popup (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function sort_popup_CreateFcn(hObject, eventdata, handles)
% hObject    handle to sort_popup (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
...
% --- Executes on button press in discard_empty_chk.
function discard_empty_chk_Callback(hObject, eventdata, handles)
% hObject    handle to discard_empty_chk (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
