function varargout = GLW_ttest_constant(varargin)
% GLW_TTEST_CONSTANT MATLAB code for GLW_ttest_constant.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_ttest_constant_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_ttest_constant_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_ttest_constant is made visible.
function GLW_ttest_constant_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_ttest_constant (see VARARGIN)
% Choose default command line output for GLW_ttest_constant
...
%!!!!!!!!!!!!!!!!!!!!!!!!
%constant_edit
set(handles.constant_edit,'String',num2str(configuration.parameters.constant));
%tail_popup
st={'both','left','right'};
...
function varargout = GLW_ttest_constant_OutputFcn(hObject, eventdata, handles) 
...
%!!!!!!!!!!!!!!!!!!!!
%constant_edit
configuration.parameters.constant=str2num(get(handles.constant_edit,'String'));
%tails_popup
st={'both','left','right'};
...
function constant_edit_Callback(hObject, eventdata, handles)
% hObject    handle to constant_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function constant_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to constant_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
