function varargout = GLW_linear_CSD(varargin)
% GLW_LINEAR_CSD MATLAB code for GLW_linear_CSD.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_linear_CSD_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_linear_CSD_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_linear_CSD is made visible.
function GLW_linear_CSD_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_linear_CSD (see VARARGIN)
% Choose default command line output for GLW_linear_CSD
...
function varargout = GLW_linear_CSD_OutputFcn(hObject, eventdata, handles) 
