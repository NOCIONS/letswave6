function varargout = GLW_merge_index(varargin)
% GLW_MERGE_INDEX MATLAB code for GLW_merge_index.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_merge_index_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_merge_index_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_merge_index is made visible.
function GLW_merge_index_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_merge_index (see VARARGIN)
% Choose default command line output for GLW_merge_index
...
function varargout = GLW_merge_index_OutputFcn(hObject, eventdata, handles) 
