function varargout = GLW_import_SET(varargin)
% GLW_IMPORT_SET MATLAB code for GLW_import_SET.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_import_SET_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_import_SET_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_import_SET is made visible.
function GLW_import_SET_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_import_SET (see VARARGIN)
% Choose default command line output for GLW_import_SET
...
function varargout = GLW_import_SET_OutputFcn(hObject, eventdata, handles) 
