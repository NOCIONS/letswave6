function varargout = GLW_average_epochs_sliding(varargin)
% GLW_AVERAGE_EPOCHS_SLIDING MATLAB code for GLW_average_epochs_sliding.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_average_epochs_sliding_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_average_epochs_sliding_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_average_epochs_sliding is made visible.
function GLW_average_epochs_sliding_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_average_epochs_sliding (see VARARGIN)
% Choose default command line output for GLW_average_epochs_sliding
...
a=find(strcmpi(configuration.parameters.operation,operation_string));
if isempty(a);
else
    set(handles.operation_popup,'Value',a(1));
end;
%dimension_popup
st=get(handles.dimension_popup,'String');
a=find(strcmpi(configuration.parameters.dimension,st));
if isempty(a);
else
    set(handles.dimension_popup,'Value',a(1));
end;
%window_width
set(handles.width_edit,'String',num2str(configuration.parameters.width));
%!!!
%END
%!!!
...
function varargout = GLW_average_epochs_sliding_OutputFcn(hObject, eventdata, handles) 
...
%dimension_popup
st=get(handles.dimension_popup,'String');
configuration.parameters.dimension=st{get(handles.dimension_popup,'Value')};
%window_width
configuration.parameters.width=str2num(get(handles.width_edit,'String'));
%!!!
%END
%!!!
