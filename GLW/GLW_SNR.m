...
% GLW_SNR MATLAB code for GLW_SNR.fig
...
% --- Executes just before GLW_SNR is made visible.
function GLW_SNR_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_SNR (see VARARGIN)
% Choose default command line output for GLW_SNR
...
%!!!!!!!!!!!!!!!!!!!!!!!!
%operation
st={'subtract' 'snr' 'zscore' 'percent'};
...
%num_extreme
set(handles.num_extreme_edit,'String',num2str(configuration.parameters.num_extreme));
%!!!
%END
%!!!
...
function num_extreme_edit_Callback(hObject, eventdata, handles)
% hObject    handle to num_extreme_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of num_extreme_edit as text
%        str2double(get(hObject,'String')) returns contents of num_extreme_edit as a double


% --- Executes during object creation, after setting all properties.
function num_extreme_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to num_extreme_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
