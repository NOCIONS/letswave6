function varargout = GLW_hilbert_bands(varargin)
% GLW_HILBERT_BANDS MATLAB code for GLW_hilbert_bands.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_hilbert_bands_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_hilbert_bands_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_hilbert_bands is made visible.
function GLW_hilbert_bands_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_hilbert_bands (see VARARGIN)
% Choose default command line output for GLW_hilbert_bands
...
%!!!!!!!!!!!!!!!!!!!!!!!!
%freq_start_edit
set(handles.freq_start_edit,'String',num2str(configuration.parameters.freq_start));
%freq_end_edit
set(handles.freq_end_edit,'String',num2str(configuration.parameters.freq_end));
%freq_lines_edit
...
function varargout = GLW_hilbert_bands_OutputFcn(hObject, eventdata, handles) 
...
%!!!!!!!!!!!!!!!!!!!!
%freq_start
configuration.parameters.freq_start=str2num(get(handles.freq_start_edit,'String'));
%freq_end
configuration.parameters.freq_end=str2num(get(handles.freq_end_edit,'String'));
%freq_lines
configuration.parameters.freq_lines=str2num(get(handles.freq_lines_edit,'String'));
%freq_width
...
function freq_low_edit_Callback(hObject, eventdata, handles)
% hObject    handle to freq_end_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function freq_low_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to freq_end_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
...
function freq_end_edit_Callback(hObject, eventdata, handles)
% hObject    handle to freq_end_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function freq_end_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to freq_end_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
...
function freq_width_edit_Callback(hObject, eventdata, handles)
% hObject    handle to freq_width_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function freq_width_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to freq_width_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
...
function freq_lines_edit_Callback(hObject, eventdata, handles)
% hObject    handle to freq_lines_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function freq_lines_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to freq_lines_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
...
function freq_start_edit_Callback(hObject, eventdata, handles)
% hObject    handle to freq_start_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function freq_start_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to freq_start_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
