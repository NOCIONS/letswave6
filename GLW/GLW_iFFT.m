...
%!!!!!!!!!!!!!!!!!!!!!!!!
set(handles.force_real_chk,'Value',configuration.parameters.force_real);
%!!!
%END
%!!!
...
%!!!!!!!!!!!!!!!!!!!!
configuration.parameters.force_real=get(handles.force_real_chk,'Value');
%!!!
%END
%!!!
...
% --- Executes on button press in force_real_chk.
function force_real_chk_Callback(hObject, eventdata, handles)
% hObject    handle to force_real_chk (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
