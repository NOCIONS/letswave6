function varargout = GLW_segmentation_chunk(varargin)
% GLW_SEGMENTATION_CHUNK MATLAB code for GLW_segmentation_chunk.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_segmentation_chunk_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_segmentation_chunk_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_segmentation_chunk is made visible.
function GLW_segmentation_chunk_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_segmentation_chunk (see VARARGIN)
% Choose default command line output for GLW_segmentation_chunk
...
%!!!!!!!!!!!!!!!!!!!!!!!!
%chunk_onset_edit
set(handles.chunk_onset_edit,'String',num2str(configuration.parameters.chunk_onset));
%chunk_duration_edit
...
function varargout = GLW_segmentation_chunk_OutputFcn(hObject, eventdata, handles) 
...
%!!!!!!!!!!!!!!!!!!!!
%chunk_onset_edit
configuration.parameters.chunk_onset=str2num(get(handles.chunk_onset_edit,'String'));
%chunk_duration_edit
...
function chunk_onset_edit_Callback(hObject, eventdata, handles)
% hObject    handle to chunk_onset_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function chunk_onset_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to chunk_onset_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
...
function chunk_duration_edit_Callback(hObject, eventdata, handles)
% hObject    handle to chunk_duration_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function chunk_duration_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to chunk_duration_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
...
function chunk_interval_edit_Callback(hObject, eventdata, handles)
% hObject    handle to chunk_interval_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% --- Executes during object creation, after setting all properties.
function chunk_interval_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to chunk_interval_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
if ispc && isequal(get(hObject,'BackgroundColor'), get(0,'defaultUicontrolBackgroundColor'))
