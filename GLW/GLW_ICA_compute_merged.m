function varargout = GLW_ICA_compute_merged(varargin)
% GLW_ICA_COMPUTE_MERGED MATLAB code for GLW_ICA_compute_merged.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_ICA_compute_merged_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_ICA_compute_merged_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before GLW_ICA_compute_merged is made visible.
function GLW_ICA_compute_merged_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to GLW_ICA_compute_merged (see VARARGIN)
% Choose default command line output for GLW_ICA_compute_merged
...
function varargout = GLW_ICA_compute_merged_OutputFcn(hObject, eventdata, handles) 
