function varargout = GLW_average_epochs(varargin)
% GLW_AVERAGE_EPOCHS MATLAB code for GLW_average_epochs.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @GLW_average_epochs_OpeningFcn, ...
                   'gui_OutputFcn',  @GLW_average_epochs_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function GLW_average_epochs_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = GLW_average_epochs_OutputFcn(hObject, eventdata, handles) 
