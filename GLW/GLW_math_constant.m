...
% varargin   command line arguments to GLW_math_constant (see VARARGIN)
% Choose default command line output for GLW_math_constant
...
%!!!!!!!!!!!!!!!!!!!!!!!!
operation_string={'add' 'subtract' 'multiply' 'divide'}
