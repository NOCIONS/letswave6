function varargout = CGLW_dataset_delete(varargin)
% CGLW_DATASET_DELETE MATLAB code for CGLW_dataset_delete.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @CGLW_dataset_delete_OpeningFcn, ...
                   'gui_OutputFcn',  @CGLW_dataset_delete_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before CGLW_dataset_delete is made visible.
function CGLW_dataset_delete_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to CGLW_dataset_delete (see VARARGIN)
...
function varargout = CGLW_dataset_delete_OutputFcn(hObject, eventdata, handles) 
