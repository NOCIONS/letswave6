function varargout = CGLW_dataset_move(varargin)
% CGLW_DATASET_MOVE MATLAB code for CGLW_dataset_move.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @CGLW_dataset_move_OpeningFcn, ...
                   'gui_OutputFcn',  @CGLW_dataset_move_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before CGLW_dataset_move is made visible.
function CGLW_dataset_move_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to CGLW_dataset_move (see VARARGIN)
...
function varargout = CGLW_dataset_move_OutputFcn(hObject, eventdata, handles) 
