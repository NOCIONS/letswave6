function varargout = CGLW_folder_rename(varargin)
% CGLW_FOLDER_RENAME MATLAB code for CGLW_folder_rename.fig
...
gui_State = struct('gui_Name',       mfilename, ...
                   ...
                   'gui_OpeningFcn', @CGLW_folder_rename_OpeningFcn, ...
                   'gui_OutputFcn',  @CGLW_folder_rename_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before CGLW_folder_rename is made visible.
function CGLW_folder_rename_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure1
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to CGLW_folder_rename (see VARARGIN)
...
function varargout = CGLW_folder_rename_OutputFcn(hObject, eventdata, handles) 
...
st2=get(handles.new_path_name_edit,'String');
disp(['Rename : ' st1 ' > ' st2]);
movefile(st1,st2);  
close;    
