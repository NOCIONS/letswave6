...
%
if ischar(loc_file)
    [dum1, dum2, Th Rd indices] = readlocs( loc_file,'filetype','loc');
elseif isstruct(loc_file) % a locs struct
    [dum1, dum2, Th Rd indices] = readlocs( loc_file );
...
for kk = 1:numChanPairs
    text(y(displayStruct.chanPairs(kk, 1)), x(displayStruct.chanPairs(kk, 1)), loc_file(displayStruct.chanPairs(kk, 1)).labels);
    text(y(displayStruct.chanPairs(kk, 2)), x(displayStruct.chanPairs(kk, 2)), loc_file(displayStruct.chanPairs(kk, 2)).labels);    
end
