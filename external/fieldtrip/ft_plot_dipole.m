function [hs_sphere,hs_stick]=ft_plot_dipole(pos, ori, varargin)
...
for i=1:size(pos,1)
  ...
  hs_sphere=ft_plot_mesh(sphere, 'vertexcolor', 'none', 'edgecolor', false, 'facecolor', color);
  hs_stick=ft_plot_mesh(stick,  'vertexcolor', 'none', 'edgecolor', false, 'facecolor', color);
