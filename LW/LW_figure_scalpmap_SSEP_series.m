function [out_configuration,out_datasets] = LW_figure_scalpmap_SSEP_series(operation,configuration,datasets,update_pointers)
% LW_figure_scalpmap_SSEP_series
% 
%
% operations : 
% 'gui_info'
...
%gui_info
gui_info.function_name='LW_figure_scalpmap_SSEP_series';
gui_info.name='Scalpmap SSEP series figure creator';
gui_info.description='Generate a series of scalpmaps at SSEP frequency and its harmonics';
gui_info.parent='figures_menu';
...
switch operation
    ...
    case 'configure'
        %configuration
        [a out_configuration]=GLW_figure_scalpmap_SSEP_series('dummy',configuration,datasets);
        %datasets
        out_datasets=datasets;
end;
