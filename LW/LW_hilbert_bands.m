function [out_configuration,out_datasets] = LW_hilbert_bands(operation,configuration,datasets,update_pointers)
% LW_hilbert_bands
% Hilbert transform and FFT across frequency bands
%
% operations : 
% 'gui_info'
% 'default'
...
%gui_info
gui_info.function_name='LW_hilbert_bands';
gui_info.name='Hilbert transform and FFT across frequency bands';
gui_info.description='Apply a Hilbert transform and FFT across frequency bands';
...
gui_info.process_filename_string='hilb-bands';    %default filename suffix (or filename (if 'unique'))
...
switch operation
    ...
    case 'default'
        ...
        out_configuration=configuration;
        out_configuration.gui_info=gui_info;
        out_configuration.parameters.freq_width=5;
    ...
    case 'configure'
        %configuration
        [a out_configuration]=GLW_hilbert_bands('dummy',configuration,datasets);
        %datasets
        out_datasets=datasets;
end;
