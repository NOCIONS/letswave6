...
%gui_info
gui_info.function_name='LW_explore_ROI';
gui_info.name='Generate table and graphs with ROI data';
gui_info.description='Explore a Region of Interest (ROI)';
...
switch operation
    ...
    case 'configure'
        %configuration
        [a out_configuration]=GLW_explore_ROI('dummy',configuration,datasets);
        %datasets
        out_datasets=datasets;
end;
