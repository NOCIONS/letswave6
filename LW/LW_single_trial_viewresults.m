function [out_configuration,out_datasets] = LW_single_trial_viewresults(operation,configuration,datasets,update_pointers)
% LW_single_trial_viewresults
%
% operations : 
% 'gui_info'
% 'default'
...
%gui_info
gui_info.function_name='LW_single_trial_viewresults';
gui_info.name='View results of single-trial analysis';
gui_info.description='View results of single-trial analysis';
...
switch operation
    ...
    case 'configure'
        %configuration
        [a out_configuration]=GLW_single_trial_viewresults('dummy',configuration,datasets);
        %datasets
        out_datasets=datasets;
end;
