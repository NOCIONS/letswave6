function [out_configuration,out_datasets] = LW_single_trial_MLR(operation,configuration,datasets,update_pointers)
% LW_single_trial_MLR
% Multiple linear regression (MLR) (Hu et al.)
%
% operations : 
% 'gui_info'
% 'default'
...
%gui_info
gui_info.function_name='LW_single_trial_MLR';
gui_info.name='Multiple linear regression (MLR) (Hu et al.)';
gui_info.description='Multiple linear regression (MLR) (Hu et al.).';
...
gui_info.process_filename_string='st-MLR';          %default filename suffix (or filename (if 'unique'))
...
switch operation
    ...
    case 'configure'
        %configuration
        [a out_configuration]=GLW_single_trial_MLR('dummy',configuration,datasets);
        %datasets
        out_datasets=datasets;
end;
