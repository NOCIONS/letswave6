function [out_configuration,out_datasets] = LW_figure_scalparray(operation,configuration,datasets,update_pointers)
% LW_figure_scalparray
% 
%
% operations : 
% 'gui_info'
...
%gui_info
gui_info.function_name='LW_figure_scalparray';
gui_info.name='Wave scalparray figure creator';
gui_info.description='Generate waveforms organized in a scalp array';
...
switch operation
    ...
    case 'configure'
        %configuration
        [a out_configuration]=GLW_figure_scalparray('dummy',configuration,datasets);
        %datasets
        out_datasets=datasets;
end;
