function [out_configuration,out_datasets] = LW_figure_scalpmap_series(operation,configuration,datasets,update_pointers)
% LW_figure_scalpmap_series
% 
%
% operations : 
% 'gui_info'
...
%gui_info
gui_info.function_name='LW_figure_scalpmap_series';
gui_info.name='Scalpmap time series figure creator';
gui_info.description='Generate a series of scalpmaps';
...
switch operation
    ...
    case 'configure'
        %configuration
        [a out_configuration]=GLW_figure_scalpmap_series('dummy',configuration,datasets);
        %datasets
        out_datasets=datasets;
end;
