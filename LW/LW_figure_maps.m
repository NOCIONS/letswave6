function [out_configuration,out_datasets] = LW_figure_maps(operation,configuration,datasets,update_pointers)
% LW_figure_maps
% 
%
% operations : 
...
%gui_info
gui_info.function_name='LW_figure_maps';
gui_info.name='Maps figure creator';
gui_info.description='Generate a figure with maps';
...
switch operation
    ...
    case 'configure'
        %configuration
        [a out_configuration]=GLW_figure_maps('dummy',configuration,datasets);
        %datasets
        out_datasets=datasets;
end;
