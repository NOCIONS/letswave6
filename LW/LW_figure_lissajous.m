function [out_configuration,out_datasets] = LW_figure_lissajous(operation,configuration,datasets,update_pointers)
% LW_figure_lissajous
% 
%
% operations : 
...
%gui_info
gui_info.function_name='LW_figure_lissajous';
gui_info.name='Lissajous figure creator';
gui_info.description='Generate a figure with lissajous plots';
...
switch operation
    ...
    case 'configure'
        %configuration
        [a out_configuration]=GLW_figure_lissajous('dummy',configuration,datasets);
        %datasets
        out_datasets=datasets;
end;
