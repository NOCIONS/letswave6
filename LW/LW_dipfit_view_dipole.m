function [out_configuration,out_datasets] = LW_dipfit_view_dipole(operation,configuration,datasets,update_pointers)
% LW_dipfit_view_dipole
% DIPFIT : view dipole(s) 
%
% operations : 
% 'gui_info'
% 'default'
...
%gui_info
gui_info.function_name='LW_dipfit_view_dipole';
gui_info.name='dipfit : view dipole(s)';
gui_info.description='dipfit : view dipole(s)';
...
switch operation
    ...
    case 'configure'
        %configuration
        [a out_configuration]=GLW_dipfit_view_dipole('dummy',configuration,datasets);
        %datasets
        out_datasets=datasets;
end;
