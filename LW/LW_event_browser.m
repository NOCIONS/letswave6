function [out_configuration,out_datasets] = LW_event_browser(operation,configuration,datasets,update_pointers)
% LW_event_browser
% event browser
%
% operations : 
...
%gui_info
gui_info.function_name='LW_event_browser';
gui_info.name='Browse and edit events';
gui_info.description='Browser and edit events.';
...
switch operation
    ...
    case 'configure'
        %configuration
        GLW_event_browser('dummy',configuration,datasets);
        %datasets
        out_configuration=configuration;
        out_datasets=datasets;
end;
