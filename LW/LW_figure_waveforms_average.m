function [out_configuration,out_datasets] = LW_figure_waveforms_average(operation,configuration,datasets,update_pointers)
% LW_figure_waveforms_average
% 
%
% operations : 
% 'gui_info'
...
%gui_info
gui_info.function_name='LW_figure_waveforms_average';
gui_info.name='Waveforms average figure creator';
gui_info.description='Generate a figure with waveform averages';
...
switch operation
    ...
    case 'configure'
        %configuration
        [a out_configuration]=GLW_figure_waveforms_average('dummy',configuration,datasets);
        %datasets
        out_datasets=datasets;
end;
