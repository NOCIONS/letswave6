function [out_configuration,out_datasets] = LW_figure_waveforms(operation,configuration,datasets,update_pointers)
% LW_figure_waveforms
% 
%
% operations : 
...
%gui_info
gui_info.function_name='LW_figure_waveforms';
gui_info.name='Waveforms figure creator';
gui_info.description='Generate a figure with waveforms';
...
switch operation
    ...
    case 'configure'
        %configuration
        [a out_configuration]=GLW_figure_waveforms('dummy',configuration,datasets);
        %datasets
        out_datasets=datasets;
end;
