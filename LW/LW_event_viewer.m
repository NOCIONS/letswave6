function [out_configuration,out_datasets] = LW_event_viewer(operation,configuration,datasets,update_pointers)
% LW_event_viewer
% event viewer
%
% operations : 
...
%gui_info
gui_info.function_name='LW_event_viewer';
gui_info.name='Event viewer : view signal at event latencies';
gui_info.description='View signal at event latencies.';
...
switch operation
    ...
    case 'configure'
        %configuration
        GLW_event_viewer('dummy',configuration,datasets);
        %datasets
        out_configuration=configuration;
        out_datasets=datasets;
end;
