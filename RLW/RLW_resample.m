    ...
    for epochpos=1:header.datasize(1);
        for chanpos=1:header.datasize(2);
            for indexpos=1:header.datasize(3);
                out_data(epochpos,chanpos,indexpos,:,:,:)=interp3(tpz,tpy,tpx,squeeze(data(epochpos,chanpos,indexpos,:,:,:)),ntpz,ntpy,ntpx);
            end;
        end;
    end;
end;
        ...
        for chanpos=1:header.datasize(2);
            for indexpos=1:header.datasize(3);
                for dz=1:header.datasize(4);
                    out_data(epochpos,chanpos,indexpos,dz,:,:)=interp2(tpy,tpx,squeeze(data(epochpos,chanpos,indexpos,dz,:,:)),ntpy,ntpx);
                end;
            end;
        end;
    end;
        ...
        for chanpos=1:header.datasize(2);
            for indexpos=1:header.datasize(3);
                for dy=1:header.datasize(5);
                    out_data(epochpos,chanpos,indexpos,:,dy,:)=interp2(tpz,tpx,squeeze(data(epochpos,chanpos,indexpos,:,dy,:)),ntpz,ntpx);
                end;
            end;
        end;
    end;
        ...
        for chanpos=1:header.datasize(2);
            for indexpos=1:header.datasize(3);
                for dx=1:header.datasize(6);
                    out_data(epochpos,chanpos,indexpos,:,:,dx)=interp2(tpz,tpy,squeeze(data(epochpos,chanpos,indexpos,:,:,dx)),ntpz,ntpy);
                end;
            end;
        end;
    end;
    ...
    for epochpos=1:header.datasize(1);
        for chanpos=1:header.datasize(2);
            for indexpos=1:header.datasize(3);
                for dz=1:header.datasize(4);
                    for dy=1:header.datasize(5);
                        out_data(epochpos,chanpos,indexpos,dz,dy,:)=interp1(tpx,squeeze(data(epochpos,chanpos,indexpos,dz,dy,:)),ntpx);
                    end;
                end;
            end;
        end;
    ...
    for epochpos=1:header.datasize(1);
        for chanpos=1:header.datasize(2);
            for indexpos=1:header.datasize(3);
                for dz=1:header.datasize(4);
                    for dx=1:header.datasize(6);
                        out_data(epochpos,chanpos,indexpos,dz,:,dx)=interp1(tpy,squeeze(data(epochpos,chanpos,indexpos,dz,:,dx)),ntpy);
                    end;
                end;
            end;
        end;
    ...
    for epochpos=1:header.datasize(1);
        for chanpos=1:header.datasize(2);
            for indexpos=1:header.datasize(3);
                for dy=1:header.datasize(5);
                    for dx=1:header.datasize(6);
                        out_data(epochpos,chanpos,indexpos,:,dy,dx)=interp1(tpz,squeeze(data(epochpos,chanpos,indexpos,:,dy,dx)),ntpz);
                    end;
                end;
            end;
        end;
